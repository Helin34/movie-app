...
const Hero=() =>{
  return (
    ...
    <h1 className="text-4xl md:text-5xl font-bold drop-shadow-md">Hoşgeldin.</h1>
    <h2 className="text-2xl md:text-3xl font-semibold">Milyonlarca Film, Dizi ve Aktörleri Keşfet.

    </h2>
    <div className="relative rounded-full flex mt-5 overflow-hidden">
      <input className="w-full p-2 px-4 text-black" type="text" placeholder="Film, Dizi, Aktör arayın..." />
